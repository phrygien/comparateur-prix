...
new class extends Component {
        ...
        try {
            ...
            foreach ($competitors as $competitor) {
                ...
                if (isset($scoreMap[$competitorId])) {
                    ...
                    $competitor->price_assessment = $this->assessPrice($competitor->prix_ht ?? 0, $ourPrice);
                }
     ...
     * Évaluer le prix
     */
    protected function assessPrice(float $competitorPrice, float $ourPrice): string
    {
        if ($ourPrice == 0) return 'non évalué';
        
        $ratio = $competitorPrice / $ourPrice;
