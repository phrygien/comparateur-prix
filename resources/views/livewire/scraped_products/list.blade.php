            ...
            <div class="flex justify-end items-center mt-3 gap-2">
                ...
                @if($showResults && $totalResults > 0)
                    <button wire:click="exportCsv"
                        class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 flex items-center gap-2">
                        <img src="https://icons.iconarchive.com/icons/carlosjj/microsoft-office-2013/256/Excel-2013-icon.png" alt="Excel"
                            class="w-5 h-5" />
                        <span>Exporter CSV ({{ $totalResults }})</span>
