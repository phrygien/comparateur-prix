...
new class extends Component {
    ...
    public function exportCsv()
    {
        ...
        try {
            ...
            // Étape 1: Récupération des données (10%)
            $this->exportProgress = 10;
            $this->exportMessage = 'Récupération des données...';
            
            $query = DB::table('last_price_scraped_product')->select('*');
            ...
            // Étape 2: Création du fichier Excel (20%)
            $this->exportProgress = 20;
            $this->exportMessage = 'Création du fichier Excel...';
            ...
            $this->exportMessage = 'Configuration des en-têtes...';
            ...
            // Étape 4: Données (30% à 80%)
            $row = 2;
            $progressStart = 30;
            $progressRange = 50; // De 30% à 80%
            ...
            foreach ($products as $index => $product) {
                ...
                if ($index % 10 == 0 || $index == $totalProducts - 1) {
                    $progress = $progressStart + ($progressRange * ($index + 1) / $totalProducts);
                    $this->exportProgress = (int)$progress;
                    $this->exportMessage = sprintf('Export en cours... %d/%d produits', $index + 1, $totalProducts);
                }
            ...
            // Étape 5: Finalisation du style (85%)
            $this->exportProgress = 85;
            $this->exportMessage = 'Application des styles...';
            ...
            // Étape 6: Génération du fichier (95%)
            $this->exportProgress = 95;
            $this->exportMessage = 'Génération du fichier...';
            ...
            // Petit délai pour que l'utilisateur voit "100%"
            sleep(1);
            ...
            <div class="progress-modal">
                ...
                <div class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p class="text-xs text-blue-800 text-center">
                        <strong>💡 Conseil :</strong> Ne fermez pas cette fenêtre pendant l'export
                    </p>
                </div>
            </div>
        </div>
