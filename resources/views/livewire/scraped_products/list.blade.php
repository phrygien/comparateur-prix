    ...
    <div class="card bg-base-100 shadow-sm mb-4">
        <div class="card-body p-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-2">
                <!-- Vendeur -->
                <div>
                    <x-input wire:model="vendor" label="Vendeur" placeholder="Filtrer par vendeur..."
                        icon="o-building-storefront" class="input-sm" hint="Exemple: Dior, Prada, etc..."
                        input-class="border border-gray-300 rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors" />
                </div>

                <!-- Nom du produit -->
                <div>
                    <x-input wire:model="name" label="Nom du produit" placeholder="Filtrer par nom..." icon="o-tag"
                        class="input-sm"
                        input-class="border border-gray-300 rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors" />
                </div>
                ...
                <!-- Type -->
                <div>
                    <x-input wire:model="type" label="Type" placeholder="Filtrer par type..." icon="o-cube"
                        class="input-sm"
                        input-class="border border-gray-300 rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors" />
                </div>
                ...
                <!-- Variation -->
                <div>
                    <x-input wire:model="variation" label="Variation" placeholder="Filtrer par variation..."
                        icon="o-arrows-pointing-out" class="input-sm"
                        input-class="border border-gray-300 rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors" />
                </div>
                ...
                <ul role="list" class="divide-y divide-gray-100">
                    @foreach($products as $index => $product)
                        ...
                        <li class="relative flex justify-between py-5 px-4 sm:px-6 stacked-list-item">
                            ...
                            <!-- Right Section: Price + Site + Actions -->
                                ...
                                <div class="flex gap-2">
                                    @if($product->url)
                                        <a href="{{ $product->url }}" target="_blank"
                                            class="btn btn-xs btn-outline btn-square border-gray-300 hover:bg-blue-50"
