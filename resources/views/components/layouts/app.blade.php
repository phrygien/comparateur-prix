    ...
    <div x-data="{ sidebarOpen: false, sidebarMinimized: localStorage.getItem('sidebarMinimized') === 'true' }" 
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:flex-col transition-all duration-300"
            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-indigo-600 px-6 relative">
                ...
                <!-- Minimize button positioned on the left border -->
                <button @click="sidebarMinimized = !sidebarMinimized" 
                        class="absolute left-0 top-1/2 -translate-y-1/2 p-1.5 bg-indigo-600 text-indigo-200 hover:text-white hover:bg-indigo-700 transition-colors rounded-r-md border border-l-0 border-indigo-400 z-10"
                                ...
                                @if(Auth::user()->email == 'admin@admin.com')
                                    <li>
                                        <a href="/import-file" 
                                           ...
                                           :class="sidebarMinimized && 'justify-center'"
                                           :title="sidebarMinimized ? 'Importer Ranking File' : ''">
