                        ...
                        <li>
                            <ul role="list" class="-mx-2 space-y-1">
                                ...
                                @if(Auth::user()->email == 'admin@admin.com')
                                    <li>
                                        <a href="/import-file" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold {{ request()->is('import-file*') ? 'bg-indigo-700 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-700' }}">
